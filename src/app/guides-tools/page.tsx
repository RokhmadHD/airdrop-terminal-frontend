...
import { getKnowledgeBaseData } from '@/lib/api';
...
export default async function GuidesAndToolsPage() {
    const sections = await getKnowledgeBaseData();
    return (
        <div className="relative container mx-auto max-w-7xl px-4 py-12">
            ...
            <div className="text-center mb-16">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight bg-gradient-to-br from-gray-700 dark:from-white to-gray-600 dark:to-gray-400 bg-clip-text text-transparent">
                    Knowledge Base
                </h1>
            ...
            <GuidesSection sections={sections}/>
